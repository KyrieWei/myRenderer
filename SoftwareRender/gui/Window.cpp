...
static void create_surface(HWND handle, int width, int height, image_t** out_surface, HDC* out_memory_dc) {
...
void window_draw_image(window_t* window, FrameBuffer* buffer) {
    blit_framebuffer_to_image(buffer, window->surface);
